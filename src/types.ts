...
export interface UseAsyncModalRenderReturn {
  ...
  /** 静默渲染工厂函数 */
  renderFactoryQuiet: AsyncModalRenderQuietFactory;
  /** 持久化渲染工厂函数 */
  renderFactoryPersistent: AsyncModalRenderPersistentFactory;
}
...
export interface AsyncModalContext {
  ...
  renderFactoryQuiet: ContextAsyncModalRenderQuietFactory;
  renderFactoryPersistent: ContextAsyncModalRenderPersistentFactory;
}
